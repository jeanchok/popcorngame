        ...
        <>
            <div className='flex flex-col md:m-6 md:w-[28%] w-full h-[124px] md:h-full p-2 md:p-0'>
                <div className='flex flex-col h-full'>
                    ...
                    <ul className='h-full overflow-y-auto scrollbar flex flex-row md:flex-col'>
                        {playersList.map((player, index) =>
                            <li key={index} className='md:ml-6 items-center md:mb-2 w-[80px] md:w-[80%] md:h-14 bg-transparent border-white md:border mr-2 flex flex-col md:flex-row h-full'>
